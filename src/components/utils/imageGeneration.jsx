...
- ${design.tier === 'Modular' ? 'Simple, clean modular design with essential elements' : design.tier === 'Hybrid' ? 'Professional design with balanced features' : 'Premium, sophisticated design with advanced features'}
