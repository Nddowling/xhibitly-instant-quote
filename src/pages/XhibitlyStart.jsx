    ...
    <div className="min-h-screen bg-[#f6f8fc] text-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 px-4 md:px-8 py-4 md:py-6">
        <div className="max-w-[1560px] mx-auto">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(280px,0.9fr)_minmax(720px,1.65fr)_minmax(340px,1fr)] items-start min-h-[calc(100vh-80px)]">
            <section className="min-w-0 h-[860px] lg:h-[calc(100vh-80px)] lg:sticky lg:top-4">
              <BoothPreviewPanel
                order={previewOrder}
            ...
            <section className="min-w-0 rounded-[30px] overflow-hidden border border-slate-200 bg-white shadow-[0_25px_70px_rgba(15,23,42,0.10)] h-[860px] lg:h-[calc(100vh-80px)]">
            ...
            <section className="min-w-0 rounded-[30px] bg-white/96 backdrop-blur border border-white shadow-[0_25px_70px_rgba(15,23,42,0.12)] overflow-hidden h-[860px] lg:h-[calc(100vh-80px)] lg:sticky lg:top-4">
