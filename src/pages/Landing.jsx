...
// Pre-generated landing images stored in app cache entity
const LANDING_IMAGES_KEY = 'xhibitly_landing_images_v3';
...
const IMAGE_PROMPTS = [
  ...
  { key: 'detail', prompt: 'Close-up detail shot of a premium trade show booth feature with a seamless integrated digital touchscreen display mounted in a sleek branded reception counter with edge-lit LED accents and custom printed fabric graphic wrap. Modern materials including brushed aluminum trim and backlit acrylic panels. Shallow depth of field, professional product photography style, warm ambient exhibition lighting.' }
];
