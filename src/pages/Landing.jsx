...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      {/* Nav */}
      <nav className="absolute top-0 left-0 right-0 z-20 px-4 sm:px-6 md:px-12 py-3 min-h-16 flex items-center justify-between gap-3 flex-wrap">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-[#e2231a] rounded-lg flex items-center justify-center font-black text-sm">EH</div>
          <span className="font-bold text-sm sm:text-base tracking-tight drop-shadow-lg leading-tight max-w-[11rem] sm:max-w-none">The Exhibitors' Handbook</span>
        ...
        <Button onClick={handleLogin} className="bg-[#e2231a] hover:bg-[#c91e16] text-white font-semibold px-4 sm:px-6 h-9 text-sm rounded-lg shadow-lg">
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        {/* Hero content */}
        <div className="relative z-10 flex-1 flex items-end pb-14 sm:pb-20 md:pb-28 px-4 sm:px-6 md:px-16 pt-24 sm:pt-28">
          <div className="max-w-2xl text-center md:text-left">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold leading-[1.05] tracking-tight mb-6 drop-shadow-2xl">
                Quote. Close.<br />
                <span className="text-[#e2231a]">Win the floor.</span>
              </h1>

              <p className="text-base md:text-lg text-white/85 max-w-lg mb-10 leading-relaxed mx-auto md:mx-0">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-center gap-4">
                <Button
                  onClick={handleLogin}
                  size="lg"
                  className="w-full sm:w-auto bg-[#e2231a] hover:bg-[#c91e16] text-white h-14 px-6 sm:px-10 text-base font-bold rounded-xl shadow-2xl shadow-[#e2231a]/30 transition-all hover:scale-[1.02]"
                >
                  Access Dealer Portal
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
                <p className="text-xs text-white/60">Authorized Orbus dealers only</p>
              </div>
              ...
              >
                {[
                  ...
                  <div key={label} className="flex items-center gap-2 bg-black/40 border border-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm text-white/85">
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-[#0a0a0a] border-t border-white/5 py-5 px-6 text-center text-xs text-white/55">
