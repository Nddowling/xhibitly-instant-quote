...
const FILE_URL = 'https://media.base44.com/files/public/69834d9e0d7220d671bfd124/7e94c8124_GLOBALPETEXPO26.xlsx';
const FILE_NAME = 'GLOBALPETEXPO26.xlsx';
const DEFAULT_SHOW_NAME = 'Global Pet Expo 26';
...
Deno.serve(async (req) => {
  try {
    ...
    for (const account of existingAccounts) {
      ...
      if (name) {
        accountMap.set(companyKey(name, ''), account);
      }
    }
