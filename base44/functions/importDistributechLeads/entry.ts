...
const FILE_URL = 'https://media.base44.com/files/public/69834d9e0d7220d671bfd124/5efa706be_DISTRIBUTECH26.xlsx';
const FILE_NAME = 'DISTRIBUTECH26.xlsx';
const DEFAULT_SHOW_NAME = 'DISTRIBUTECH 26';
...
Deno.serve(async (req) => {
  try {
    ...
    const existingLeads = await base44.asServiceRole.entities.Lead.list('-created_date', 5000);
