...
Deno.serve(async (req) => {
    try {
        ...
        for (const product of products) {
            ...
            // 1. Most Specific Items first (Outdoor, Accessories, Components)
            if (name.includes('tent') || name.includes('canopy') || sku.startsWith('TNT-') || sku.startsWith('ZOOM-FLX-TNT')) {
                category = 'Outdoor';
                subcategory = 'Tents';
            ...
            } else if (name.includes('hanging') || sku.startsWith('TRI-') || sku.startsWith('CYL-') || sku.startsWith('SHD-') || sku.startsWith('TOWER-')) {
                category = 'Hanging Structures';
            ...
            // 4. Portable Displays
            else if (name.includes('retractable') || name.includes('roll up') || name.includes('rollup')) {
            ...
            // 5. Fabric Displays (Most generic names here)
            ...
            } else if (sku.startsWith('FMLT') || sku.startsWith('ARCH') || sku.startsWith('HOP') || sku.startsWith('EMB') || name.includes('fabric') || name.includes('formulate') || name.includes('hopup') || name.includes('embrace') || name.includes('arch') || name.includes('wall') || name.includes('waveline') || name.includes('tower') || sku.startsWith('VF-K-') || sku.startsWith('VF-')) {
                category = 'Fabric Displays';
